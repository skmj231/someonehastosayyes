...
for (const item of cases) {
  ...
  assert.equal(entry.status, "testing");
...
assert.match(approval, /Raw HR record absent from SHSY request and notification/);
assert.match(approval, /Required checks before VERIFIED/);
